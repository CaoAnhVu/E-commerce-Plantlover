...
namespace Cs_Plantlover.Models.Services
{
    public class VnPayService : IVnPayService
    {
        ...
        public Cs_Plantlover.Infrastructure.VnPaymentResponseModel PaymentExecute(IQueryCollection collections)
        {
            var vnpay = new VnPayLibrary();
            ...
            if (!checkSignature)
            {
                return new Cs_Plantlover.Infrastructure.VnPaymentResponseModel
                {
                    Success = false,
